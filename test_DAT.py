...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_dir', type=str, default='save_DAT', help='The directory used to save models')
    ...
    parser.add_argument('--result_dir', type=str, default='result_DAT', help='result directory')
    parser.add_argument('--lr', '--learning_rate', default=4.8e-4, type=float, help='initial learning rate')
    parser.add_argument('--epoch_num', default=1, type=float, help='number of epochs loaded')
    main()
